...
$cat_deleted = $cat->delete_category("plan_cat_id");
...
<div class="container mt-5" id="category_list">
  ...
  <div class="col-md-9 mb-4">
    <div class="card mb-4">
      <div class="card-header py-3">
        <h5 class="mb-0">PLAN CATEGORIES</h5>
      </div>
        <div>
      ...
      <div class="card-body" style="min-height:200px">
        <a href="add_plan_category.php" class="btn btn-success">Add New</a>
  ...
  <?php $sn = 1;  ?>
    ...
    <tr>
      <th scope="row"><?php echo $sn++;  ?></th>
        <td><?php   echo $cat["plan_cat_title"]; ?></td>    
        <td><?php   echo $cat["plan_cat_desc"]; ?></td>
        <td><?php   echo $cat["plan_cat_date_added"]; ?></td>
        <td style="display:flex !important;">
          <form action="process/delete_plan_category_process.php" method="post">
            <input type="hidden" name="plan_cat_id" value="<?php echo $cat["plan_cat_id"]; ?>">
          ...
          <a href="edit_plan_category.php?id=<?php echo $cat["plan_cat_id"]; ?>" class='btn btn-sm btn-success'><i class='fa fa-pencil'></i> Edit</a>
      </td>
      </tr>
  <?php
      }
